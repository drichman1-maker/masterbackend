        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div className="card text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Health First</h3>
            ...
            <div className="card text-center">
              ...
              <h3 className="font-semibold text-gray-900 dark:text-white mb-2">Trusted Reviews</h3>
              <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Red Light Therapy</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">PEMF Therapy</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Infrared Saunas</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <div className="text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-2">Massage Guns</h3>
            <p className="text-sm text-gray-600 dark:text-gray-400">
      ...
      <div className="mb-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          <div className="card text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-3">Research</h3>
          ...
          <div className="card text-center">
            ...
            <h3 className="font-bold text-gray-900 dark:text-white mb-3">Test</h3>
            <p className="text-gray-600 dark:text-gray-400 text-sm">
